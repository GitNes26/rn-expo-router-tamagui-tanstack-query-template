...
const CustomDrawerContent = ({ ...props }) => {
   ...
   return (
      <View className={'flex-1'}>
         <DrawerContentScrollView {...props} contentContainerStyle={{ backgroundColor: theme.color1 }}>
                  ...
                  caption={
                     <View>
                        ...
                        <Text className={`font-mmedium text-primary-100 text-[15px] text-center mt-2`}>
                           <Ionicons name="arrow-forward-outline" className={`my-auto`} size={13} color={theme.color10} />
                           &nbsp; Ir a mi perfil
                        </Text>
                     </View>
                  }
         ...
         <View className={`pb-[${20 + bottom}]`} style={{ borderTopColor: theme.gray1.get(), borderTopWidth: 1 }}>
            <ButtonCompnent
...
const DrawerGroup = ({ data }) => {
   ...
   return (
      <Drawer
         ...
         screenOptions={{
            drawerActiveBackgroundColor: theme.color12,
            drawerActiveTintColor: theme.color1,
